...
rm(list=ls())
this_dir <- 'E:/mymodel/methodcompare/datasets/panc2tech_pca/'

out_dir<-"E:/mymodel/methodcompare/results/panc 2 tech/"

dataset_use = 'panc2tech'
...
get_cells_integration_iLISI_v2_panc2tech(dataset_use, meta_ls, out_dir, plx, eval_metric)


get_celltype_mixing_cLISI_panc2tech(dataset_use, out_dir, plx, eval_metric)
